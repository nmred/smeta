	...
	public function get_static_path()
	{
		...
		$map = array(
			...
			'URL_JS_ADMIN'     => $tpl_static_admin . 'js/',
				...
				'URL_JS_PROJECT_MANAGE_ADMIN'   => $tpl_static_admin . 'js/project_manage.js' .$this->get_version(),
				'URL_JS_PROJECT_LIST_ADMIN'   => $tpl_static_admin . 'js/project_list.js' .$this->get_version(),
