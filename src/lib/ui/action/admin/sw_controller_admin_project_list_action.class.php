...
class sw_controller_admin_device_list_action extends sw_controller_action_web
{
	...
	public function action_default()
	{
		...
		$device_condition->set_columns(array('device_id', 'device_display_name', 'host', 'snmp_version', 'snmp_protocol'));
		try {
	...
	protected function _get_detail()
	{
		...
		$list['base']['device_display_name']  = $tmp_arr['device_display_name'];
