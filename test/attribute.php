...
$monitor_attribute_property = sw_member::property_factory('monitor_attribute', array('attr_name' => 'test33333333', 'form_type' => 1));
...
//
// 获取 monitor attribute 详细信息
$monitor = sw_member::operator_factory('monitor');
$monitor_attribute = $monitor->get_operator('attribute')->get_info(1, 1);
var_dump($monitor_attribute);

// 删除 monitor attribute
//$condition = sw_member::condition_factory('del_monitor_attribute', array('monitor_id' => 6, 'attr_id' => 4));
...
//$monitor_property_attribute = sw_member::property_factory('monitor_attribute', array('attr_display_name' => 'rt1111sssssssss22'));
//$condition = sw_member::condition_factory('mod_monitor_attribute', array('attr_id' => 4, 'monitor_id' => 6));
