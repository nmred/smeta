...
CREATE TABLE `device` (
	...
	`port` smallint(6) UNSIGNED ,
	`snmp_version` tinyint(2) UNSIGNED ,
	`snmp_method` tinyint(2) UNSIGNED ,
	`snmp_protocol` tinyint(2) UNSIGNED ,
	`snmp_community` varchar(32) ,
	`snmp_timeout` int(6) UNSIGNED ,
	`snmp_retries` tinyint(2) UNSIGNED ,
	`security_name` varchar(32) ,
	`security_level` tinyint(2) UNSIGNED ,
	`auth_protocol` tinyint(2) UNSIGNED ,
	`auth_passphrase` varchar(32) ,
	`priv_protocol` tinyint(2) UNSIGNED ,
...
CREATE TABLE `rrd_ds` (
	...
	`device_id` int(11) UNSIGNED NOT NULL ,
	`get_method` tinyint(2) UNSIGNED ,
	`object_type` char(32) ,
	`object_id` varchar(255) ,
	`source_type` tinyint(2) UNSIGNED ,
	`heart_time` int(11) UNSIGNED ,
	`min` varchar(32) ,
	`max` varchar(32) ,
	PRIMARY KEY (`ds_id`),
...
CREATE TABLE `rrd_line_area` (
	...
	`graph_id` int(11) UNSIGNED NOT NULL ,
	`line_cate` tinyint(2) UNSIGNED NOT NULL ,
	`define_name` varchar(32) NOT NULL ,
...
CREATE TABLE `rrd_gprint` (
	...
	`line_cf` tinyint(2) UNSIGNED NOT NULL ,
